...
lib.read = (dir, file, callback) => {
  fs.readFile(`${lib.baseDir}${dir}/${file}.json`, 'utf8', (err, data) => !err && data ? callback(false, helpers.parseJsonToObject(data)) : callback(err, data));
};
...
lib.delete = (dir, file, callback) => {
  // Unlink the file
  fs.unlink(`${lib.baseDir}${dir}/${file}.json`, err => !err ? callback(false) : callback('Trouble deleting file.'));
};
